...
public static class EditorUIHelper
{
    ...
    public static bool PropertyField(SerializedObject obj, string name, string lable)
    {
        return EditorGUILayout.PropertyField(obj.FindProperty(name), new GUIContent(lable));
    }
